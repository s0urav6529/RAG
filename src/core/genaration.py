...
class QuestionAnsweringService:
    ...
    def generate_answer(self, state: State):
        try:
            ...
            prompt = ChatPromptTemplate.from_messages([("human", "You are an assistant of Smart Field Service for question-answering tasks. Use the following pieces of retrieved context to answer the question. If you don't know the answer, just say that Thanks, please visite our official website to know more. Use three/four sentences maximum and keep the answer concise.\nQuestion: {question} \nContext: {context} \nAnswer:"),])
